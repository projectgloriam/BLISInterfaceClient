 ...
 *  Fritz Adomako      - Software Developer
 * 
 */
package ui;

import  RS232.*;
import RS232.MindrayBC3600;
import TCPIP.*;
import MSACCESS.*;
import TEXT.BDFACSCalibur;
import TEXT.BT3000PlusChameleon;
...
public class MainForm extends javax.swing.JFrame {
	...
	private SYSMEXKX21N objsysKS21;
	private RS232.SYSMEXXP300 objsysXP300Serial;
	private TCPIP.SYSMEXXP300 objsysXP300Tcip;
	private BeckmanCoulterDxH500 objBeckmanCoulterDxH500;
        private DiaSysRespons920 objDiaSysRespons920;
        private SYSMEXXN350 objsysXN350;
	private URIT3000Plus objUrit3000plus;
	private MindrayBC2800 objmin2800;
	private BT3000Plus objbt3000;
	private BT3000PlusChameleon1_0_7 sysobjC1_0_7;
	private FlexorJunior flexjobj;
	private SYSMEXXN1000 sys1000obj;
	private MindrayBS300 objminbs300;
	private Thread selproSObj;
	private TCPIP.MindrayBC3600 objmin3600;
	private MindrayBC5380 objmin5380;
	private URIT5250 objurit5250;
	private MindrayBS240 objminbs240;
	private BT3000PlusChameleon btTXTobj;
	private TEXT.SelectraJunior txtSelobj;
	private BT3000PlusChameleonEnvoy objbtenvoy;
   ...
   public static RESET set= RESET.WAIT;
    ...
    private void initTray()
    {
         if (SystemTray.isSupported()) {
            ...
            trayIcon = new TrayIcon(iconImage, "Analyzer Interfacing Software "+settings.VERSION, menu);
    ...
    private void initComponents() {
        ...
        setTitle("Analyzer Interfacing Software V"+settings.VERSION);
        setResizable(false);
            ...
            case "RS232":
                switch(jlblEquipment.getText().toUpperCase())
                {
                    ...
                    case "SYSMEX KX-21N":
                        ...
                        break;
                    case "SYSMEX XP-300":
                        objsysXP300Serial = new RS232.SYSMEXXP300();
                        objsysXP300Serial.start();
                        break;
            ...
            case "TCP/IP":
                switch(jlblEquipment.getText().toUpperCase())
                {
                    ...
                    case "SYSMEX XS-500I":
                        ...
                        break;
                    case "SYSMEX XP-300":
                        objsysXP300Tcip = new TCPIP.SYSMEXXP300();
                        objsysXP300Tcip.start();
                        break;
                     case "COBAS AMPLIPREP":
                     ...
                     case "SELECTRA PROS":
                      ...
                      case "MINDRAY BS-240":
                          ...
                          objminbs240.start();
                          break;
                      case "BECKMAN COULTER DXH500":
                    	  objBeckmanCoulterDxH500 = new BeckmanCoulterDxH500();
                    	  objBeckmanCoulterDxH500.start();
                    	  break;
                      case "SYSMEX XN-350":
                    	  objsysXN350 = new SYSMEXXN350();
                    	  objsysXN350.start();
                    	  break;
                      case "DIASYS RESPONS 920":
                    	  objDiaSysRespons920 = new DiaSysRespons920();
                    	  objDiaSysRespons920.start();
                    	  break;    
                }
                break;
             case "MSACCESS":
                ...
                switch(jlblEquipment.getText().toUpperCase())
                {
                    ...
                    case "MINDRAY BS-300":                        
                     ...
                     case "MINDRAY BS-240":                          
                          ...
                          break;
                     case "Beckman Coulter DxH500":
                    	 objBeckmanCoulterDxH500.Stop();
                    	 break;
                     case "DiaSys Respons 920":
                    	 objDiaSysRespons920.Stop();
                    	 break;    
                }
                break;
            case "MSACCESS":
