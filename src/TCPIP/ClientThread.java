            ...
            while(true)
            {
                try
                {
                  inFromEquipment=new BufferedReader(new InputStreamReader (connSock.getInputStream()));
                    ...
                    else if (this.Equipmentname.equalsIgnoreCase("SYSMEX XS-500I") || this.Equipmentname.equalsIgnoreCase("COBASAMPLIPREP") || this.Equipmentname.equalsIgnoreCase("SYSMEX XP-300") || this.Equipmentname.equalsIgnoreCase("SYSMEX XN-350"))
                    {
                        int c=0;
                        int val;
                        String line ="";
                    ...
                    else if(this.Equipmentname.equalsIgnoreCase("BT3000PlUSChameleon") || this.Equipmentname.equalsIgnoreCase("SYSMEX XT-2000i") || this.Equipmentname.equalsIgnoreCase("Beckman Coulter DxH500") || this.Equipmentname.equalsIgnoreCase("SYSMEX XP-300"))
                    {
                        int c=0;
                        int val;
                        String line ="";
                    ...
                    else if(this.Equipmentname.equalsIgnoreCase("GENEXPERT") || this.Equipmentname.equalsIgnoreCase("DiaSys Respons 920"))
                    {
                        int c=0;
                        int val;
                        String line ="";
                  ...
                  if(!read.isEmpty())
                  {
                    ...
                    switch(this.Equipmentname)
                    {
                        ...
                        case "SYSMEX XT-2000i":
                            ...
                            break;
                        case "SYSMEX XP-300":
                        	SYSMEXXP300.handleMessage(read);
                                break;
                        case "SYSMEX XN-350":
                        	SYSMEXXN350.handleMessage(read);
                        	break;
                        case "Beckman Coulter DxH500":
                        	BeckmanCoulterDxH500.handleMessage(read);
                        	break;
                        case "DiaSys Respons 920":
                        	DiaSysRespons920.handleMessage(read);
                        	break;        
                    }   
                  }
